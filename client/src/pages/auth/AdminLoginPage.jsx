    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4 overflow-hidden relative">
      ...
      >
        <div className="text-center mb-8">
          ...
          />
          <h1 className="font-heading text-3xl font-bold text-text mb-1 tracking-wide">ADMIN LOGIN</h1>
        ...
        <form onSubmit={handleAdminSubmit} className="space-y-4">
          <div>
            <label className="block text-xs text-text-2 mb-1.5 ml-1">Admin Email or Username</label>
            <div className="relative">
              ...
              <input 
                ...
                placeholder="manager@appleesports.com or operator username"
              />
            </div>
          </div>
